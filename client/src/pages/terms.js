...
export default function Terms({ location }) {
  return (
    <div>
      <GlobalStyles />
      <Typography />
      <Seo title="Terms" location={location} />
      <TermsStyles>
        <div className="container">
          <h1>Terms and Conditions</h1>
          <p>Last updated: June 27, 2021</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Web Cifar, Chittagong, Bangladesh.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Web Cifar, accessible from{' '}
                <a
          ...
          <ul>
            <li>By email: webcifar@gmail.com</li>
            <li>
              <p>By phone number: +8801647-579727</p>
            </li>
          </ul>
        </div>
      </TermsStyles>
